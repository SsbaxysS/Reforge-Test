...
export default function TestPage() {
    ...
    // Render phases with enter/exit animations
    return (
            ...
            {phase === 'test' && (() => {
                ...
                return (
                    <motion.div key="test"
                        ...
                        exit={{ opacity: 0, x: -20 }}
                        transition={{ duration: 0.3 }}
                        className="min-h-screen pt-6 pb-20 px-6"
                        style={{ background: 'var(--bg)' }}>
                        <div className="max-w-3xl mx-auto">
                            ...
                            <div className="flex flex-wrap items-center justify-between gap-3">
                                <button onClick={() => setCurrentStage(Math.max(0, currentStage - 1))} disabled={currentStage === 0}
                                    className="px-4 py-2 rounded-xl text-sm font-medium transition-all disabled:opacity-30 active:scale-95"
                                ...
                                {currentStage === test.stages.length - 1 ? (
                                    <button onClick={() => {
                                        ...
                                        disabled={submitting}
                                        className="px-5 py-2 rounded-xl text-sm font-medium text-white transition-all disabled:opacity-50 active:scale-95"
